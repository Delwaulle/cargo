...
public class DetailsTrajet extends HttpServlet {
	public void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		out.println("Ville de depart : " + req.getParameter("depart") + "<br/>");
		out.println("Ville d'arrivee : " + req.getParameter("arrivee") + "<br/>");
		out.println("Date du trajet : " + req.getParameter("date") + "<br/>");
		out.println("Heure de depart : " + req.getParameter("heureDepart") + "<br/>");
